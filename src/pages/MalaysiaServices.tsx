...
const MalaysiaServices = () => {
  ...
  useEffect(() => {
    fetchServicesPageSettings("MY")
      .then(data => setContent(data))
      .catch(err => console.error("Failed to load Malaysia services settings:", err));
  }, []);
  ...
  const defaultServices = [
    { id: 1, title: 'Ocean Freight', description: 'At GGL, we specialize in providing comprehensive ocean freight solutions that cater to the diverse needs of our clients. Whether you\'re shipping large volumes or smaller consignments, our services are designed to ensure efficiency, reliability, and cost-effectiveness', image: '/mocean.png', link: '/malaysia/services/ocean-freight', icon: getIcon('Anchor') },
    { id: 2, title: 'LCL Consolidation', description: 'We collect your goods from your location and prepare them for consolidation. This includes proper labelling, packaging, and documentation to ensure smooth transit.', image: '/mlcl.png', link: '/malaysia/services/lcl-consolidation', icon: getIcon('Warehouse') },
    { id: 3, title: 'Transportation And Distribution', description: 'At GGL, we understand that efficient transportation and distribution are the backbone of a seamless supply chain. Our dedicated fleet and robust infrastructure ensure that your goods reach their destination on time, every time.', image: '/mtransport.png', link: '/malaysia/services/transportation', icon: getIcon('Truck') },
    { id: 4, title: 'Warehousing', description: 'At GGL, we offer comprehensive warehousing and third-party logistics (3PL) solutions designed to streamline your supply chain operations. Our services are tailored to meet the diverse needs of businesses, ensuring efficiency, reliability, and scalability.', image: '/mwarehouse.png', link: '/malaysia/services/warehousing', icon: getIcon('Warehouse') },
    { id: 5, title: 'Air Freight', description: 'At GGL, we offer a comprehensive range of air freight services designed to meet all your shipping needs. Our expert air freight teams provide seamless air import, export, and express options, all on a convenient door-to-door basis.', image: '/mair.png', link: '/malaysia/services/air-freight', icon: getIcon('Plane') },
    { id: 6, title: 'Project Cargo', description: 'At GGL, we specialize in managing project cargo—the transportation of large, heavy, high-value, or complex pieces of equipment and materials essential to major infrastructure, engineering, or industrial projects.', image: '/mproject.png', link: '/malaysia/services/project-cargo', icon: getIcon('Warehouse') }
  ];
