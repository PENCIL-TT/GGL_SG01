...
const Careers = () => {
  ...
  // Fallbacks in case query has no data
  const heroTitle = content?.hero_title || (isBangladesh ? "Join Our Team in Bangladesh" : "Join Our Global Team");
  const heroSubtitle = content?.hero_subtitle || (isBangladesh 
    ? "Build your career with one of Bangladesh's leading logistics companies. We're looking for passionate individuals to join our mission of connecting the world through exceptional logistics solutions."
  ...
  const whyJoinTitle = content?.why_join_title || "Why Choose GGL?";
  ...
  const opportunitiesDescription = content?.opportunities_description || "Explore exciting career opportunities across our various departments and locations.";
