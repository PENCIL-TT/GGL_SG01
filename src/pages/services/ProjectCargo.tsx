        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            ...
            {data?.features_list && data.features_list.length > 0 ? (
              ...
              <>
                {/* Key Characteristics Section (Default Static) */}
                ...
                {/* Why Choose GGL Section (Default Static) */}
                <div className="max-w-4xl mx-auto mb-16">
                  <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center text-gray-800">
                ...
                {/* Benefits Section (Default Static) */}
                <div className="max-w-4xl mx-auto mb-16">
                  <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center text-gray-800">
            ...
            >
              ...
              <p className="mb-6 text-blue-50 max-w-3xl mx-auto">
                {data ? "" : "From the first mile to the final lift, GGL is your strategic partner in project cargo and international logistics. Our team of project specialists will work closely with you to plan every detail, ensure compliance, and execute a seamless delivery."}
              </p>
              <Link
                to={data?.cta_button_link || navPaths.contact}
