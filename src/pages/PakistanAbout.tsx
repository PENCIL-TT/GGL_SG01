...
const PakistanAbout = () => {
  const [content, setContent] = useState({
    hero_title: "GGL Pakistan: Logistics Excellence in Karachi & Lahore",
    hero_subtitle: "Local expertise powered by our global network to keep Pakistan supply chains moving by sea, air, and road.",
  ...
  useEffect(() => {
    fetch("/api/about-us-page/PK")
      ...
      .then(data => {
        setContent({
          hero_title: data.hero_title || "GGL Pakistan: Logistics Excellence in Karachi & Lahore",
