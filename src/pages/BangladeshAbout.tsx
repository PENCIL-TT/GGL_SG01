...
const BangladeshAbout = () => {
  ...
  useEffect(() => {
    fetch("/api/about-us-page/BD")
      ...
      .then(data => {
        setContent({
          hero_title: data.hero_title || "GGL Bangladesh: Logistics Excellence in Dhaka",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
                  <span className="text-[navy-blue] text-brand-navy">{content.about_title}</span>
                </h2>
