...
const fallbackCountries = [
  { code: "pk", name: "Pakistan", lat: 30.3753, lng: 69.3451, cities: [{ name: "Karachi", lat: 24.8608, lng: 67.0097, address: "Suite No. 507 & 508, 5th Floor Fortune Center, Block-6, P.E.C.H.S, Shahrah-e-Faisal, Karachi, Pakistan.", contacts: ["+92 21 34542881/ +92 21 34542882/ +92 21 34542883/ +92 21 34542884"], email: "info.pk@ggl.sg" }] },
];
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (!hasInitialized) {
      const pakistan = activeCountriesList.find(c => c.name === "Pakistan");
      if (pakistan && pakistan.cities.length > 0) {
        const firstCountry = pakistan;
        ...
        // Fallback to first country if Pakistan not found
