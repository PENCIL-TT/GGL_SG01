...
const MAboutUs = ({ learnMorePath = "/malaysia/about", imageSrc = "/lovable-uploads/14c89acc-9c64-4484-b520-f5142136ccc6.png" }: MAboutUsProps) => {
  ...
  useEffect(() => {
    fetchAboutUsRecord("MY")
      .then(res => {
        if (res) setData(res);
      })
      .catch(err => console.log("Using default local About Us MY content:", err));
  }, []);
