...
export const BQuickEnquiry = () => {
  ...
  useEffect(() => {
    fetch('/api/quick-enquiry/BD')
      ...
      .catch(err => console.log('Using default static Bangladesh Quick Enquiry content:', err));
  }, []);
