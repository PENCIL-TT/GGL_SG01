...
export const MQuickEnquiry = () => {
  ...
  useEffect(() => {
    fetch('/api/quick-enquiry/MY')
      ...
      .catch(err => console.log('Using default static Malaysia Quick Enquiry content:', err));
  }, []);
